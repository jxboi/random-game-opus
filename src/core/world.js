...
import { BuildingBehaviour } from './buildings.js';
import { CombatBehaviour } from './combat.js';
import { BUILDINGS, DIFFICULTY, FOODS, PLAYER_COLORS, SOLDIERS, TICK, WARFARE } from './data.js';
import { FIELD_GROW_TIME, ORE_NAMES, TREE_MATURE, TREE_STAGE_TIME, T_MOUNTAIN, T_WATER, WINE_GROW_TIME, generateMap } from './map.js';
import { PathFinder } from './path.js';
import { setupTowns } from './setup.js';
import { UnitBehaviour } from './units.js';
...
export class World {
  ...
  checkEnd() {
    ...
    if (alive.length <= 1) {
      ...
      if (winner === 0) this.emit('victory'); else this.emit('defeat');
    }
  }
...
Object.assign(World.prototype, UnitBehaviour, BuildingBehaviour, CombatBehaviour);
