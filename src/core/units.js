...
// ---------------------------------------------------------------------------
import { FOODS, FOOD_LIST, TICK } from './data.js';
import { TREE_MATURE, T_WATER } from './map.js';
import { hash2 } from './util.js';

export const HUNGRY = 0.35;
export const CITIZEN_HUNGER = 1 / 700;   // condition lost per second
export const SOLDIER_HUNGER = 1 / 1000;

export const UnitBehaviour = {
