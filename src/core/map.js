...
// ---------------------------------------------------------------------------
import { RNG, clamp, dist, fbm, hash2, lerp, smoothstep, valueNoise } from './util.js';

export const T_GRASS = 0, T_WATER = 1, T_MOUNTAIN = 2, T_SAND = 3;
export const ORE_NAMES = ['', 'coal', 'iron', 'gold'];
export const TREE_MATURE = 5;
export const TREE_STAGE_TIME = 45;     // seconds per growth stage
export const FIELD_GROW_TIME = 110;    // corn seconds from sowing to ripe
export const WINE_GROW_TIME = 130;
...
// ---------------------------------------------------------------------------
export function generateMap(seed, W = 96, H = 96) {
...
export function ensureConnected(m, a, b) {
  const W = m.W;
