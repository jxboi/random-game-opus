...
const TICK = 0.1;          // simulated seconds per simulation tick (10 ticks / s)
...
const GOOD_LIST = Object.keys(GOODS);

// Food value restores this fraction of a unit's condition.
const FOODS = { bread: 0.4, sausage: 0.6, wine: 0.3, fish: 0.5 };
const FOOD_LIST = Object.keys(FOODS);

const WARFARE = ['axe', 'lance', 'bow', 'wooden_shield', 'leather_armor',
...
const CITIZEN_LIST = Object.keys(CITIZENS);
...
const SOLDIER_LIST = Object.keys(SOLDIERS);
...
const BUILDING_LIST = Object.keys(BUILDINGS);
const BUILD_GROUPS = ['Town', 'Basic', 'Food', 'Industry', 'Military'];

// Goods each building accepts as input, derived from recipes and kinds.
function buildingInputs(def) {
  const set = new Set();
